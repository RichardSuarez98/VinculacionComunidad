...
@Component({
  selector: 'app-gestor-vinculacionmodulo',
  templateUrl: './gestor-vinculacionmodulo.component.html',
  styleUrls: ['./gestor-vinculacionmodulo.component.css']
})
export class GestorVinculacionmoduloComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(_finaldata.idRol===6){
     ...
     }else if(_finaldata.idRol===3){ // DIRECTOR DE PROYECTO
      this.getCarrera();
      this.getAnioLectivo();
      this.getProyecto();
     //this.habilitarBotonSupervisor=false;
