...
@Component({
  selector: 'app-certificado-supervisor',
  templateUrl: './certificado-supervisor.component.html',
  styleUrls: ['./certificado-supervisor.component.css']
})
export class CertificadoSupervisorComponent implements OnInit {
